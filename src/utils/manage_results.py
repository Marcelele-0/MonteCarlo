...
def visualize_results(
    ...
    if exact_value is not None:
        axes[0].axhline(y=exact_value, color=colors['exact'], linestyle='--', label='Exact integral value')
    ...
    if exact_value is not None:
        axes[1].axhline(y=exact_value, color=colors['exact'], linestyle='--', label='Exact integral value')
